...
def inquiry(request):
    if request.method == 'POST':
        ...
        if request.user.is_authenticated: 
            ...
            if has_contacted:
                messages.error(request, 'You have already made am inquiry about this car. Please wait until we get back to you.')
        ...
        send_mail(
            ...
            's.kiaei.s.m.m.k1380@gmail.com',
            [admin_email],
            fail_silently=False,
        )
        
        contact.save()
        messages.success(request, 'Your request has been submitted, we will contact you as soon as possible.')
        return redirect('/cars/'+car_id)